...
def sum_array(array)
  ...
  # adding the first element to the rest
  # separating the first element using the [0..-1] slice method, reduces the part being added by just an itzy bit allowing us to use recursion 
...
def reverse_string(str)
  ...
  # reversing the above scenerio, reverses the operations 
...
def flatten(data)
  ...
  data.each do |elm|
    # using += concatenates the array, combining them, instead of adding an array inside the other array
    flattened += flatten(elm)
  end 
