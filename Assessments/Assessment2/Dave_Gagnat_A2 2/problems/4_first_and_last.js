...
function firstAndLast(array) {
  ...
  if (isEven(array.length)) {
    ...
    total = difference;
    return difference // missing semi-colon - MS
  }

}

// I think this is a situationw here you overcomplcted the solution a bit,
// probably don't need a helper function but it works, watch out for
// missing semi-colons - MS
