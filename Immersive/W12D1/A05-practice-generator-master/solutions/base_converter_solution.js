...
/* 
converts an arbitrary number by first taking the number and dividing by the base, thus
decreasing the number. This is then used to determine the index of digits and then
that character is returned. This process repeats concatenating each digit until the 
number is included in the array of [0, 1] which is then converted into a string and 
returns the stack.
