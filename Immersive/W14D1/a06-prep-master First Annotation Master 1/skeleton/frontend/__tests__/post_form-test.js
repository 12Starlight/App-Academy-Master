...
describe('post form container', () => {
  ...
  describe('creating a new post', () => {
    ...
    it('updates the title and body fields when they change', () => {
      // here were are simulating a change event, so we definitely want an 
      // onChange callback
    ...
    it('triggers the correct action when submitted', () => {
      ...
      // simiulate is a hint that we are using an event handler
  ...
  describe('updating an existing post', () => {
    beforeEach(() => {
      ...
      /* 
        It is saying hey give me an EditPostForm container, but the props 
        are specifically the props that going to the PostForm inside of the 
        EditPostForm
      */ 
      ).find('PostForm'); 
