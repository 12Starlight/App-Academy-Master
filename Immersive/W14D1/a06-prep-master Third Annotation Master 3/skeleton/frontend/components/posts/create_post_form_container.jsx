...
// we are only importing createPost, so we need to use it
...
const mapDispatchToProps = (dispatch) => {
  return({
    ...
    /*
      ...
      action. So, now, instead of our post form component, the api is still
      going to be the same. We just say action, and we get the appropriate 
      function
    */
