  ...
  */
  ...
  update(field) {
    ...
    return e => this.setState({
      // now we can say whatever field this function was called on, we want
  ...
  handleSubmit(e) {
    ...
    /* 
      ...
      whatever the user has input as a result of our update function whenever
      you want to see what your props are, go to your container 
    */
    ...
    return (
      <div>
        <form onSubmit={ this.handleSubmit }>
          ...
          />
          {/* got to __tests__ post_form-test to find why it is not input */}
