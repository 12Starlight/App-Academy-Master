...
describe('event index', () => {
  ...
  it('renders a EventIndexItem for each event, passing in each event as a "event" prop', () => {
    const eventsIndexItems = eventIndexWrapper.find('ul').children();
    expect(eventsIndexItems.nodes.length).toBe(3);
  ...
  it('Links to the EventForm page', () => {
