...
def starts_with_g
  ...
  # ..% takes everything to the left of the percent for first name 
  # %.. takes everything to the right of the percent for last name
  # % only lets you work with one string data at a time
  execute(<<-SQL)
    SELECT
      name
    FROM
